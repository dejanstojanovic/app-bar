...
namespace WinAppBar.Extensions
{
    ...
    {
        public static void EnableAcrylic(this Form window, Color blurColor)
        {
            EnableAcrylic(window as IWin32Window, blurColor);
        }

        public static void EnableAcrylic(this IWin32Window window, Color blurColor)
        {
